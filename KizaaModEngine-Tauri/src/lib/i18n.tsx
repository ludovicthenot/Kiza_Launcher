...
const fr: Record<string, string> = {
  ...
  // Kiza Client Runtime panel
  "Kiza Client Runtime": "Client Kiza",
  // "Checking" and "Ready" are already in the dictionary above.
  "Degraded": "Partiel",
  "Failed": "En échec",
  "Installed": "Installé",
  "Needs install": "À installer",
  "Launcher only": "Launcher seul",
  "Compatibility is being checked": "Compatibilité en cours de vérification",
  "Never started on this instance.": "Jamais démarré sur cette instance.",
  "Active now": "Actif maintenant",
  "At the last launch": "Au dernier lancement",
  "menu-theme": "Thème du menu",
  "window-branding": "Titre de la fenêtre",
  "discord-presence-state": "Présence Discord",
  "local-state-bridge": "Pont d'état local",
  "Launcher interface": "Interface du launcher",
  ...
  "Running": "En cours",
  "Expected on this version": "Prévu sur cette version",
  ...
  "Installing Kiza Client Runtime": "Installation du runtime client Kiza",
  ...
  "Client only — runs where you play, not on a server": "Client uniquement — tourne là où tu joues, pas sur un serveur",
  "Server only — runs where the world is, not on your machine": "Serveur uniquement — tourne là où est le monde, pas sur ta machine",
  "Both sides — needed on your machine and on a server": "Les deux côtés — nécessaire sur ta machine et sur un serveur",
  "Unknown — nothing this mod ships says which side it runs on": "Inconnu — rien dans ce mod ne dit de quel côté il tourne",
  "Only what a server needs": "Seulement ce dont un serveur a besoin",
  "Client-only mods are left out. Anything nothing could classify is kept.": "Les mods client uniquement sont exclus. Ce qui n'a pas pu être identifié est conservé.",
